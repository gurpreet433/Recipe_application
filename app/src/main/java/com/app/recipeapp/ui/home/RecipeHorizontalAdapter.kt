...
import com.app.recipeapp.databinding.RecyclerviewItemHorizontalBinding
import com.app.recipeapp.pojo.network.Hit
import com.app.recipeapp.pojo.network.Recipe
import com.bumptech.glide.Glide

class RecipeHorizontalAdapter(private val itemClickListener: OnRecipeItemHorizontalClickListener) : RecyclerView.Adapter<RecipeHorizontalAdapter.RecipeViewHolder>() {

    private var hits: List<Hit> = emptyList()

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecipeViewHolder {
        val inflater = LayoutInflater.from(parent.context)
        val binding: RecyclerviewItemHorizontalBinding =
            RecyclerviewItemHorizontalBinding.inflate(inflater, parent, false)
    ...
    inner class RecipeViewHolder(private val binding: RecyclerviewItemHorizontalBinding) :
    ...
    interface OnRecipeItemHorizontalClickListener {
